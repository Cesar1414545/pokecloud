...
define(['./workbox-b31f0c4c'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    request,
    url
  }) => request.destination === "script" || request.destination === "style" || url.pathname.startsWith("/assets/"), new workbox.StaleWhileRevalidate({
